...
% Mengklasifikasi semua citra yang ada pada folder
% membaca file citra
...
nama_folder = 'data uji/semua citra yang diuji';
...
%     ciri_tabel = cell(n,8);
    ciri_tabel{n,1} = fullfile(nama_file(n).name);
    ciri_tabel{n,2} = hasil_uji{1};
    ciri_tabel{n,3} = num2str(Red);
    ciri_tabel{n,4} = num2str(Green);
    ciri_tabel{n,5} = num2str(Blue);
    ciri_tabel{n,6} = num2str(Hue);
    ciri_tabel{n,7} = num2str(Saturation);
